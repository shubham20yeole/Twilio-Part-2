...
@media screen and (max-width: 320px){
    ...
    <body>
					<span>My Expertise are </span>
					<div class="rw-words rw-words-1">
						<span>Java 8 & Apache Tomcat Server</span>
						<span>Hibernate and Spring framework</span>
						<span>Spring (MVN) framework</span>
						<span>Google APIs & multimedia storing on server via FTP and HTTPS</span>
