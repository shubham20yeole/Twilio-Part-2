...
//			ex.SMS("2018875323", "Tested From "+From+" \n"+result);
	...
	public String hashMapClass(String code){
    	...
    	data.put("501","Please reply us with 4-digit pin for Mr. John Cena. This pin code is required to keep students record confidential. (USE PIN 5011 for testing)");
    	data.put("502","Please reply us with 4-digit pin for Mr Abraham Bond . This pin code is required to keep students record confidential. (USE PIN 5022 for testing)");
    	data.put("503","Please reply us with 4-digit pin for Mr Noa Capsi. This pin code is required to keep students record confidential. (USE PIN 5033 for testing)");
    	data.put("601","Please reply us with 4-digit pin for Mr Mich Leriche. This pin code is required to keep students record confidential. (USE PIN 6011 for testing)");
    	data.put("602","Please reply us with 4-digit pin for Mr David P Perlmutter. This pin code is required to keep students record confidential. (USE PIN 6022 for testing)");
    	data.put("603","Please reply us with 4-digit pin for Mr Tobias Edstrom. This pin code is required to keep students record confidential. (USE PIN 6033 for testing)");
    	data.put("701","Please reply us with 4-digit pin for Mr Dave Bush. This pin code is required to keep students record confidential. (USE PIN 7011 for testing)");
    	data.put("702","Please reply us with 4-digit pin for Mr Daniel Bostos. This pin code is required to keep students record confidential. (USE PIN 7022 for testing)");
    	data.put("703","Please reply us with 4-digit pin for Mr Ludmila Lupan. This pin code is required to keep students record confidential. (USE PIN 7033 for testing)");
